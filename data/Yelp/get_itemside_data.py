...
if __name__ == '__main__':
    ...
    with open('/data1/home/xingmei/GRE/data/Yelp/filtered_Yelp_rating.pkl', 'rb') as f:
        trn_set = pickle.load(f)
        tst_set = pickle.load(f)
        dataset = pickle.load(f)


    dataset.item_feat[['business_id', 'text']].to_csv(f'/data1/home/xingmei/GRE/itemside_data/{category}.csv', 
                            sep='\t',
                            header=True,
                            index=False)
