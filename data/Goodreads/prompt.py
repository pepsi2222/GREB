...
if __name__ == '__main__':
    ...
    review = json.load(open(f'/data1/home/xingmei/GRE/data/Goodreads/filtered_reviews.json'))
...
"""         },
    ...
    with open(f'/data1/home/xingmei/GRE/data/Goodreads/prompt.json', 'w') as f:
